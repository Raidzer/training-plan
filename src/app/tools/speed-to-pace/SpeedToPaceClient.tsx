    ...
    <section className={styles.page}>
      <header className={styles.header}>
        <h1 className={styles.title}>
          Калькулятор перевода скорости (км/ч, м/с, миль/ч) в темп (мин/км,
          мин/милю)
        </h1>
        <div className={styles.titleLine} />
        <p className={styles.description}>
          Позволяет мгновенно перевести скорость в разные единицы измерения
          (км/ч, м/с, миль/ч), скорость в темп (мин/км, мин/милю) и обратно.
        </p>
        <p className={styles.description}>
          Просто заполните одно из значений, остальные пересчитаются
          автоматически.
        </p>
      </header>
